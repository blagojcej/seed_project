...
class _View_MessageInputComponent0 extends import1.AppView<import3.MessageInputComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_0,'class','col-md8 col-md-offset-2');
...
export function viewFactory_MessageInputComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MessageInputComponent> {
  if ((renderType_MessageInputComponent === (null as any))) { (renderType_MessageInputComponent = viewUtils.createRenderComponentType('C:/TestProjects/seed-project/01 Seed/assets/app/messages/message-input.component.html',0,import9.ViewEncapsulation.None,styles_MessageInputComponent,{})); }
